...
abstract contract D_ListInitialization is Debot, Upgradable {
    bytes m_icon;
    ...
    function savePublicKey(string value) public {
        ...
        //uint res = 0x1fccea5c0660acbc5f616c1500a3a5243a81d2545ae6a5b79a0af1f22586a948;
        //bool status = true;
        if (status) {
            m_masterPubKey = res;
    ...
    function setStat(ShoppingSummary shoppingSummary) public {
        m_ShoppingSummary = shoppingSummary;
        _menu();
    }
    ...
    function _getStat(uint32 answerId) public view {
        optional(uint256) none;
        I_ShoppingList(m_address).getShoppingSummary{
            abiVer: 2,
            extMsg: true,
            sign: false,
            pubkey: none,
